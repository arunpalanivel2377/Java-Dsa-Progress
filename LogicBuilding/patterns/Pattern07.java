...
- We have to take care of three things in each row:  
  ...
  1. **Print spaces before the stars** → `n - i - 1` spaces.  
  2. **Print stars** → `2 * i - 1` stars in each row.  
  3. **Print spaces after the stars** → `n - i - 1` spaces (though it's not needed for output formatting).  

Pattern breakdown for `N = 3`:
Row 1 → 2 spaces, 1 star, 2 spaces
Row 2 → 1 space, 3 stars, 1 space
Row 3 → 0 spaces, 5 stars, 0 spaces  
